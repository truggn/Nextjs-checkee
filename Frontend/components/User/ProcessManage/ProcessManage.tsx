...
} from "../../../redux/actions/user/ProcessManageActions";
...
function ProcessManage() {
  ...
  useEffect(() => {
    dispatch(loadProcessManage(organizationData?.organizationId));
  }, [organizationData]);
  ...
  const state_processmanage: IListProcessManage[] = useSelector(
    (state: any) => state.ProcessManageUser.processmanagedata
  );
