...
import { actionTypes } from "../../actions/user/ProductTypeActions";
...
const Productreducer = (state = initialState, action: any) => {
  return produce(state, (draft) => {
    switch (action.type) {
      //action get data
      case actionTypes.LOAD_DATA_PRODUCTTYPEUSER_SUCCESS:
        successLoadDataProductType(draft, action.payload);
        break;
      case actionTypes.LOAD_DATA_PRODUCTTYPEUSER_FAIL:
        failLoadDataProductType(draft, action.payload);
        break;
      //action delete
      case actionTypes.DELETE_DATA_PRODUCTTYPEUSER_SUCCESS:
      ...
      case actionTypes.DELETE_DATA_PRODUCTTYPEUSER_FAIL:
        return {
          ...state,
          error: action.payload,
        };
      //action create
      case actionTypes.CREATE_DATA_PRODUCTTYPEUSER:
        return {
          ...state,
          loading: false,
        };
      case actionTypes.CREATE_DATA_PRODUCTTYPEUSER_SUCCESS:
        const data_ = [
      ...
      case actionTypes.CREATE_DATA_PRODUCTTYPEUSER_FAIL:
        return {
          ...state,
          error: action.payload,
          loading: false,
      ...
      //action update
      case actionTypes.UPDATE_DATA_PRODUCTTYPEUSER:
        return {
          ...state,
          loading: false,
        };
      case actionTypes.UPDATE_DATA_PRODUCTTYPEUSER_SUCCESS:
      ...
      case actionTypes.UPDATE_DATA_PRODUCTTYPEUSER_FAIL:
        return {
          ...state,
          error: action.payload.error,
          loading: false,
        };
      case actionTypes.VERIFIED_DATA_PRODUCTTYPEUSER_SUCCESS:
      ...
      case actionTypes.VERIFIED_DATA_PRODUCTTYPEUSER_FAIL:
        return {
          ...state,
          error: action.payload.error,
          loading: false,
