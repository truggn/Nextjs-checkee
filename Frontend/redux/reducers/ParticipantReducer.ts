...
import { actionTypes } from "../actions/ParticipantActions";
...
const reducer = (state = initialState, action: any) => {
  return produce(state, (draft) => {
    switch (action.type) {
      case actionTypes.LOAD_DATA_PARTICIPANT_SUCCESS:
        successData(draft, action.payload);
        break;
      case actionTypes.CREATE_DATA_PARTICIPANT_SUCCSESS:
      ...
      case actionTypes.UPDATE_DATA_PARTICIPANT_SUCCESS:
        ...
        break;
      case actionTypes.LOAD_DATA_PARTICIPANT_FAILURE ||
        actionTypes.CREATE_DATA_PARTICIPANT_FAILURE ||
