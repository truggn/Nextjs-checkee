...
import { actionTypes } from "../actions/ProcessManageActions";
...
const reducer = (state = initialState, action: any) => {
  return produce(state, (draft) => {
    switch (action.type) {
      case actionTypes.LOAD_PROCESS_MANAGE_SUCCESS:
        successData(draft, action.payload);
        break;
      case actionTypes.CREATE_PROCESS_MANAGE_SUCCSESS:
      ...
      //     break;
      case actionTypes.LOAD_PROCESS_MANAGE_FAILURE ||
        actionTypes.CREATE_PROCESS_MANAGE_FAILURE:
