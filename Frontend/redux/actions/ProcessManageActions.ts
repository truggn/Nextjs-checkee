...
export const actionTypes = {
    //get data
    LOAD_PROCESS_MANAGE: "LOAD_PROCESS_MANAGE",
    LOAD_PROCESS_MANAGE_SUCCESS: "LOAD_PROCESS_MANAGE_SUCCESS",
    LOAD_PROCESS_MANAGE_FAILURE: "LOAD_PROCESS_MANAGE_FAILURE",
    // /// delete data
    ...
    ///create data
    CREATE_PROCESS_MANAGE: "CREATE_PROCESS_MANAGE",
    CREATE_PROCESS_MANAGE_SUCCSESS: "CREATE_PROCESS_MANAGE_SUCCSESS",
    CREATE_PROCESS_MANAGE_FAILURE: "CREATE_PROCESS_MANAGE_FAILURE",
    // //update data
...
//
export function loadProcessManage() {
    return {
        type: actionTypes.LOAD_PROCESS_MANAGE,
    };
}

export function loadProcessManageSuccess(data: IListProcessManage[]) {
    return {
        type: actionTypes.LOAD_PROCESS_MANAGE_SUCCESS,
        payload: {
            data: data,
        },
    };
...
export function loadProcessManageFailure(error: any) {
    return {
        type: actionTypes.LOAD_PROCESS_MANAGE_FAILURE,
        payload: {
            error: error,
        },
    };
...
//   //
  export function createProcessManage(values: IListProcessManage) {
    return {
      type: actionTypes.CREATE_PROCESS_MANAGE,
      payload: values,
    };
  }
  ...
  export function createProcessManageSuccess(data: IListProcessManage[]) {
    return {
      type: actionTypes.CREATE_PROCESS_MANAGE_SUCCSESS,
      payload: {
        data,
      },
    };
  ...
  export function createProcessManageFailure(error: any) {
    return {
      type: actionTypes.CREATE_PROCESS_MANAGE_FAILURE,
      payload: {
        error: error,
      },
    };
