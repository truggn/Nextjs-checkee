...
//   updateDataSuccess,
//   updateDataFailure
} from "../actions/ProcessManageActions";
import getProcessManage from "../../constant.config.api/api/getProcessManage";
import createProcessManage from "../../constant.config.api/api/createProcessManage";
...
function* loadDataSaga() {
  try {
    const res = yield call(getProcessManage);
...
// }
const sagas = [
  takeLatest(actionTypes.LOAD_PROCESS_MANAGE, loadDataSaga),
  takeLatest(actionTypes.CREATE_PROCESS_MANAGE, createDataSaga),
