...
import getParticipant from "../../constant.config.api/api/getParticipant";
...
function* loadDataSaga() {
  try {
    const res = yield call(getParticipant);
...
const sagas = [
  takeLatest(actionTypes.LOAD_DATA_PARTICIPANT, loadDataSaga),
  takeLatest(actionTypes.CREATE_DATA_PARTICIPANT, createDataSaga),
