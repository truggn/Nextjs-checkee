...
//import api
import getProductType from "../../constant.config.api/api/getProductType";
import createProductType from "../../constant.config.api/api/createProductType";
import deletedProductTye from "../../constant.config.api/api/deleteProductType";
import updateProductType from "../../constant.config.api/api/updateProductType";
import verifiedProductType from "../../constant.config.api/api/verifiedProductType";
import allCateAPI from "../../constant.config.api/api/getAllCategory";
//
function* loadDataProductType() {
  try {
    const ProductTypeData = yield call(getProductType);
...
const ProductTypeSaga = [
  takeLatest(actionTypes.LOAD_DATA_PRODUCTTYPE, loadDataProductType),
  takeLatest(actionTypes.DELETE_DATA_PRODUCTTYPE, deletedDataProductType),
  takeLatest(actionTypes.CREATE_DATA_PRODUCTTYPE, createDataProductType),
  takeLatest(actionTypes.UPDATE_DATA_PRODUCTTYPE, updateDataProductType),
  takeLatest(actionTypes.VERIFIED_DATA_PRODUCTTYPE, verifiedDataProductType),
